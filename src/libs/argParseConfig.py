...
def parser():
    ...
    # Optional arguments
    parser.add_argument('-a', '--ants', type=int, default=50, help='Number of ants in each iteration (default: 50)')
    ...
    parser.add_argument('-i', '--iterations', type=int, default=50, help='Number of iterations to be executed (default: 50)')
